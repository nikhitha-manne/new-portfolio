...
const Navbar = () => {
  ...
  <span className="text-lg md:text-xl ml-[-3px] mt-[19px]">IKHITHA</span> 
  <span className="mx-1"></span> {/* Space between words */}
  <span className="text-2xl md:text-5xl leading-none">M</span>
  <span className="mx-0.5"></span>
  <span className="text-lg md:text-xl ml-[-3px] mt-[19px]">ANNE</span>
</Link>
